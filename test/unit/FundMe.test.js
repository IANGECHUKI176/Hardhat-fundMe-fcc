...
!developmentChains.includes(network.name)
    ...
    : describe("FundMe", function () {
          ...
          beforeEach(async function () {
              ...
              //  const account= await ethers.getSigners() ->returns array of accounts
              deployer = (await getNamedAccounts()).deployer
              //fixture->allows run deploy folder with as many tags as you want
              await deployments.fixture(["all"])
              //getContract->gets the most recent deployment of the contract
          ...
          describe("constructor", function () {
              it("It sets the aggregator addresses correctly", async function () {
          ...
          describe("withdraw", () => {
              ...
              it("withdraw ETH  from a single account", async () => {
                  //arrange
              ...
              it("allow us withdraw ETH this mutliple getFunder", async () => {
                  //arrange
          ...
          describe("getVersion", async () => {
              it("get the version of the contract", async () => {
